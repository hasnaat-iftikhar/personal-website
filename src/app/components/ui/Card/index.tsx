...
const Card: FC<CardProps> = ({
    ...
    return (
        <Link href={`/case-studies/${id}`} className='group outline-0 border-0 relative bg-[#272727] w-full h-[600px] rounded-[28px] flex justify-start items-end p-[36px] 2xl:p-[42px] overflow-hidden'>
            <Image
                src={image}
                fill
                alt={`Card - ${title}`}
